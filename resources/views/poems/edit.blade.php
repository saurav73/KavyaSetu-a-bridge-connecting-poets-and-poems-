...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="mb-8">
        <h1 class="text-3xl font-serif font-bold text-gray-900">Edit Your Poem</h1>
    </div>
    ...
    <form method="POST" action="{{ route('poems.update', $poem->slug) }}" class="bg-white rounded-lg shadow-md p-8">
        @csrf
        @method('PUT')
        ...
        <div class="mb-8">
            ...
            <textarea 
                ...
                required>{{ old('body', $poem->body) }}</textarea>
        </div>
        ...
        <div class="mb-6">
            <label class="flex items-center">
                <input 
                    ...
                    name="is_published" 
                    value="1"
                    @checked(old('is_published', $poem->is_published))
                    class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                <span class="ml-2 text-sm text-gray-700">Publish this poem</span>
            </label>
        </div>
